...
nx g @nx/angular:service constancias --project client-users --path=libs/client-users/src/lib/services
...
nx g @nx/angular:interceptor HttpStatusCode --project shared --path=libs/shared/src/lib/interceptors
...
nx g @nx/angular:component users-constancias --path=apps/users/src/app/users/components --project users --module=users --dry-run
...
nx g @nx/angular:interface Constancia --project client-users --path=libs/client-users/src/lib/models --type=model
